 ...
 * on 2014-10-30 at 05:05:46 UTC 
 * Modify at your own risk.
 */

package com.huertapp.messageEndpoint;
...
public class MessageEndpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class ListMessages extends MessageEndpointRequest<com.huertapp.messageEndpoint.model.CollectionResponseMessageData> {
    ...
    protected ListMessages() {
      super(MessageEndpoint.this, "GET", REST_PATH, null, com.huertapp.messageEndpoint.model.CollectionResponseMessageData.class);
    }
   ...
   * @return the request
   */
  public SendMessage sendMessage(java.lang.String message, java.lang.String type) throws java.io.IOException {
    SendMessage result = new SendMessage(message, type);
    initialize(result);
    return result;
  }
  ...
  public class SendMessage extends MessageEndpointRequest<Void> {
    ...
    private static final String REST_PATH = "sendMessage/{message}/{type}";
     ...
     * @since 1.13
     */
    protected SendMessage(java.lang.String message, java.lang.String type) {
    ...
    public SendMessage setType(java.lang.String type) {
      this.type = type;
      return this;
    }
