 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "huertapp.com", ownerName = "huertapp.com", packagePath=""))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyDHIqhj-klVW4J2hg9nsm5BZF97Go3ZMIk";
  ...
  public void sendMessage(@Named("message") String message,@Named("type") String type)
      throws IOException {
    ...
    for (DeviceInfo deviceInfo : response.getItems()) {
      doSendViaGcm(message,type, sender, deviceInfo);
    }
  }
   ...
   */
  private static Result doSendViaGcm(String message, String type,Sender sender,
    ...
    Message msg = new Message.Builder().addData("message", message).addData("type", type).build();
